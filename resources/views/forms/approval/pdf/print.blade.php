...
{{-- <header> --}}
    <div class="headerSection">
        ...
        <div class="logoAndName">
            ...
            <h4>PLN (Persero) UIP2B UP2B JATENG & DIY</h4>
            <!-- <h1>Logo &amp; Name</h1> -->
        </div>
        <h1>SURAT PERINTAH KERJA INTERN (SPKI)</h1>
    </div>
{{-- </header> --}}
{{-- <main> --}}
    {{-- <form name="application" action="https://en7spkvxc7gii.x.pipedream.net" method="POST"> --}}
        <label class="w200 sublabel">NOMOR</label>
        <br>
        <div class="formLine">
            <div class="w66">
                <label>Nomor SPK</label>
                <input type="text" name="AddressStreet" value={{$data[0]['spk_number']}} />
            </div>
        </div>
        <br>
        <label class="w100 sublabel">PEKERJAAN</label>
        <br>
        <div class="formLine">
            <div class="w66">
                <label>Hari / Tanggal</label>
                <input type="text" name="AddressStreet" value={{$data[0]['effective_date']}} />
            </div>
        </div>
        <div class="formLine">
            <div class="w66">
                <label>Nama Pekerjaan</label>
                <input type="text" name="AddressStreet" value={{$data[0]['description']}} />
            </div>
        </div>
        <div class="formLine">
            <div class="w66">
                <label>Lokasi</label>
                <input type="text" name="AddressStreet" value={{$data[0]['location']}} />
            </div>
        </div>
        <div class="formLine">
            <div class="w66">
                <label>Pelaksana Pekerjaan</label>
                <input type="text" name="AddressStreet" value={{$data[0]['job_executor']}} />
            </div>
        </div>
        <div class="formLine">
            <div class="w66">
                <label>Pengawas Pekerjaan</label>
                <input type="text" name="AddressStreet" value={{$data[0]['job_supervisor']}} />
            </div>
        </div>
        <div class="formLine">
            <div class="w66">
        ...
        <div class="formLine">
            <div class="w66">
                ...
                <input type="text" name="AddressStreet" value={{$data[0]['wo_description']}} />
            </div>
        </div>
    {{-- </form> --}}
    ...
    {{-- <aside> --}}
        <div style="width: 50%; float:left; text-align:center">
            <label>Yang Menerima Perintah</label>
            <br>
            <br>
            <br>
            <br>
            <br>
            <br>
            <label> {{$data[0]['job_executor']}} </label>
        </div>

        <div style="width: 50%; float:right; text-align:center">
            <label id="date_spk" style="text-align:right">Ungaran, {{$data[0]['effective_date']}}</label>
            <br>
