...
@section('auth')
<h4 class="pull-left page-title">Tambah Data Autorisasi</h4>
<ol class="breadcrumb pull-right">
    <li><a href="#">{{Auth::user()->name}}</a></li>
    <li class="active">Tambah Data Autorisasi</li>
</ol>
...
<div class="container">
            ...
            <form id="formUpload" enctype="multipart/form-data" method="POST">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">Upload Data Autorisasi</h3>
                    </div>
    ...
    <div id="div-main-table" class="row">
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Preview Data Autorisasi</h3>
                </div>
                <div class="panel-body">
...
<script>
    ...
    $(function() {
        ...
        var oTable = $('#main-table').DataTable(
        {
            ...
            ajax: {
                'url': '{!! route('masters/autorisation/display-upload') !!}',
                'type': 'POST',
                'headers': {
            ...
            columns: [
                ...
                {data: 'name' ,         name: 'name'      },
                {data: 'role' ,               name: 'role'            },
                {data: 'autorisation' ,        name: 'autorisation'     },
    ...
    $('#template_department').click(function(){
        ...
        var uri = encodeURI("{{url('/masters/autorisation/download-template')}}");
    ...
    $("#btnSubmit").click(function(e) {
        ...
        $.ajax({
            ...
            url: '{!! route('masters/autorisation/upload') !!}', // This is the url we gave in the route
            headers: {
                'X-CSRF-TOKEN': '{!!csrf_token()!!}'
            },
            data: {
    ...
    function doSaveUpload(){
        ...
        artLoadingDialogDo("Harap tunggu, sedang dalam proses...",function(){
            $.ajax({
                type: 'POST',
                url: '{!! route('masters/autorisation/save-upload') !!}', 
                headers: {
                    'X-CSRF-TOKEN': '{!!csrf_token()!!}'
                },
                data: {
